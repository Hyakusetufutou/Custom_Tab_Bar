...
struct Home: View {
    ...
    @ViewBuilder
    func CustomTabBar(_ tint: Color = Color("CustomBlue"), _ inacitveTint: Color = .blue) -> some View {
        HStack(alignment: .bottom, spacing: 0) {
            ForEach(Tab.allCases, id: \.rawValue) {
                TabItem(tint: tint, inactiveTint: inacitveTint, tab: $0, animation: animation, activeTab: $activeTab, position: $tabShapePosition)
            }
        }
